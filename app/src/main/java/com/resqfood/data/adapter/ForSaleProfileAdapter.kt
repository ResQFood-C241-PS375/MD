...
//
//class ForSaleProfileAdapter(private val listener: SaleActionListener) : ListAdapter<ListSaleProfileItem, ForSaleProfileAdapter.ViewHolder>(ForSaleProfileAdapter.DIFF_CALLBACK) {
//
